...
public class RubricPdfActivity extends AppCompatActivity implements OnPageChangeListener,OnLoadCompleteListener {

    private static final String TAG = RubricPdfActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rubric_pdf);

        path = Environment.getExternalStorageDirectory().getAbsolutePath() + "/Rubricon/Rubrics";
        String file_path = Environment.getExternalStorageDirectory().getAbsolutePath() + "/Rubricon/Rubrics/Rubric.pdf";
        dir = new File(path);
        if (!dir.exists()) {
            dir.mkdirs();
        }
...
//        fetch data from the db using the rubricID
        RubricTable rubricDb = new RubricTable(this);
        rubricDb.open();
        String result = rubricDb.getData(Integer.parseInt(RubricID));
        rubricDb.close();

        String[] strArray = result.split(",");
//        Use this value when there is something in database

        TextView txtTitle = (TextView) findViewById(R.id.textView_header);
        txtTitle.setText("Rubric Title:" + "Rubric One");
    ...
    public void createPDF() throws FileNotFoundException, DocumentException {
        ...
        try {
            ...
            try {
                ...
                cell = new PdfPCell();
                cell.setBorder(Rectangle.NO_BORDER);
                cell.addElement(new Paragraph("Rubric"));
